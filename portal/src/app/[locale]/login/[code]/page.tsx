    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#09090b]">
        <div className="text-center">
          ...
          <p className="text-white/40 text-sm">{t("checking")}</p>
        </div>
      </div>
    );
  }
          ...
          <div className="portal-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-green-400 font-medium">
                    {t("codeRecognized") || "Zugangscode erkannt"}
                  </p>
                  <p className="text-xs text-green-400/60 mt-0.5">
                    {t("clickToLogin") || "Klicken Sie auf \"Einloggen\" um fortzufahren"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-white/[0.06]">
              <p className="text-center text-xs text-white/30">
                {t("accessCreated") || "Dieser Zugang wurde für Sie erstellt."}
              </p>
            </div>
          </div>

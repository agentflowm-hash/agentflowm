...
// ═══════════════════════════════════════════════════════════════
//         PORTAL LOGIN - Manuelle Code-Eingabe
// URL: /login (ohne Code - Nutzer gibt Code selbst ein)
// ═══════════════════════════════════════════════════════════════
          ...
          <div className="portal-card">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-white/40">Geben Sie Ihren Zugangscode ein</p>
              </div>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                ...
                <p className="mt-2 text-xs text-white/30 text-center">
                  Den Zugangscode haben Sie per E-Mail oder Telegram erhalten.
                </p>
              </div>

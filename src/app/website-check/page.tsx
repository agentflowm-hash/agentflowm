...
// ═══════════════════════════════════════════════════════════════
//                    HERO VISUALIZATION
// Scanner Animation mit den 5 Kategorien
// ═══════════════════════════════════════════════════════════════

function HeroVisualization() {
  const categories = [
    { icon: "🔒", label: "Sicherheit", color: "#22c55e" },
    { icon: "🔍", label: "SEO", color: "#06b6d4" },
    { icon: "♿", label: "Barrierefreiheit", color: "#a855f7" },
    { icon: "⚡", label: "Performance", color: "#FFB347" },
    { icon: "🏗️", label: "Struktur", color: "#FC682C" },
  ];
  ...
  return (
    <div className="relative w-full h-[320px] sm:h-[380px] md:h-[420px] flex items-center justify-center">
      ...
      {/* Category Icons - Positioned around center */}
...
const checkCategories = [
  {
    icon: "🔒",
    title: "Sicherheit",
    desc: "HTTPS, Security Headers, SSL-Zertifikat und mehr",
    color: "#22c55e",
    checks: [
      "HTTPS aktiv",
      "Security Headers",
  ...
  },
  {
    icon: "🔍",
    title: "SEO",
    desc: "Meta-Tags, Struktur, Indexierbarkeit prüfen",
    color: "#06b6d4",
    checks: [
  ...
  },
  {
    ...
    desc: "WCAG-Konformität und Accessibility-Standards",
    color: "#a855f7",
    checks: [
  ...
  },
  {
    icon: "⚡",
    title: "Performance",
    desc: "Ladezeit, Ressourcen und Core Web Vitals",
    color: "#FFB347",
    checks: ["Ladezeit", "Bildoptimierung", "Caching", "Ressourcen-Größe"],
  },
  {
    icon: "🏗️",
    title: "Struktur",
    desc: "HTML-Validität, semantische Struktur, Links",
    color: "#FC682C",
    checks: ["HTML-Validierung", "Semantik", "Broken Links", "Sitemap"],
  },
];
      ...
      <div className="container px-4 sm:px-6">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
            Was wir <span className="text-[#06b6d4]">analysieren</span>
          </h2>
          <p className="text-white/50 max-w-2xl mx-auto">
            Umfassende Prüfung Ihrer Website in 5 kritischen Bereichen
          </p>
        </motion.div>
...
export default function WebsiteCheckPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) throw new Error(data.error || "Fehler beim Prüfen");
        ...
        <div className="container relative z-10 px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                Sicherheit, SEO, Barrierefreiheit, Performance & Struktur - in
                Sekunden analysiert.
              </motion.p>
              ...
              >
                {[
                  ...
                  { value: "30+", label: "Checks" },
                  { value: "< 10s", label: "Analyse" },
                ].map((stat, i) => (
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white/[0.02]">
        <div className="container px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                Jetzt <span className="text-[#06b6d4]">prüfen</span>
              </h2>
              <p className="text-white/50">
                Geben Sie Ihre URL ein und erhalten Sie sofort Ergebnisse
              </p>
            </motion.div>
              ...
              >
                ...
                >
                  ...
                  <p className="text-xs text-white/40 text-center">
                    Wir analysieren nur öffentlich sichtbare Inhalte. Keine
                    invasiven Scans.
                  </p>
                </form>
              </motion.div>
        ...
        <div className="container px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-white/60 mb-8 max-w-xl mx-auto">
              Wir helfen Ihnen, alle Schwachstellen zu beheben und Ihre Website

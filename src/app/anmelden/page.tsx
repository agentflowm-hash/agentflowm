...
// ═══════════════════════════════════════════════════════════════
//                    TELEGRAM LOGIN PAGE
// Code-basiertes Login über Telegram Bot
// ═══════════════════════════════════════════════════════════════
...
export default function AnmeldenPage() {
  ...
  // Starte Polling wenn Code-Step aktiv
  useEffect(() => {
    if (step === "code") {
      // Poll alle 2 Sekunden für Telegram Updates
      const poll = async () => {
        try {
        ...
        >
          ...
          {step === "start" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-white/50">Schnell & sicher mit Telegram</p>
              </div>
          ...
          {step === "success" && userData && (
            ...
            >
              ...
              <p className="text-white/50 text-sm mb-1">Angemeldet als</p>

...
export async function GET() {
  ...
  try {
    ...
    const data = {
      ...
      topReferrers: [
        { domain: "google.de", visits: 1823 },
        { domain: "linkedin.com", visits: 342 },
        { domain: "instagram.com", visits: 234 },
        { domain: "facebook.com", visits: 187 },
      ],
      searchTerms: [
        { term: "website erstellen lassen", clicks: 234 },
        { term: "web agentur berlin", clicks: 187 },
        { term: "app entwicklung", clicks: 145 },
        { term: "agentflow", clicks: 98 },
      ],
    };

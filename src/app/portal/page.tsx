    ...
    <div className="min-h-screen bg-[#030308] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-2xl font-bold text-white mb-2">Kundenportal</h1>
          <p className="text-white/50">
            Melden Sie sich mit Ihrem Zugangscode an
          </p>
        </div>
        ...
        <div className="mt-6 p-4 rounded-xl bg-white/5 border border-white/10">
          <p className="text-sm text-white/60 text-center">
            Ihren Zugangscode erhalten Sie per E-Mail oder Telegram nach
            Projektbuchung.
          </p>
        </div>

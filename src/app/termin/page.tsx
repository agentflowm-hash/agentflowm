...
function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        <label className="block text-sm font-medium mb-2">Interesse an</label>
        <select
      ...
      <section className="relative pt-24 sm:pt-28 md:pt-32 pb-10 sm:pb-12 md:pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Kurzes Gespräch, klare Antworten - kein Verkaufsdruck.
            </p>
            ...
            >
              {[
                ...
                { value: "30min", label: "Erstgespräch" },
              ...
              <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      },
                      {
                        icon: "📧",
                        label: "E-Mail",
                        sublabel: "kontakt@agentflowm.com",
                ...
                <div className="p-6 rounded-3xl bg-white/[0.03] border border-white/10">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-semibold">Standort Berlin</h3>
                  </div>
